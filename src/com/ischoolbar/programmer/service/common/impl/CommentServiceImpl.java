...
public class CommentServiceImpl implements CommentService {
	...
	@Override
	public List<Comment> findList2(Map<String, Object> queMap) {
		// TODO Auto-generated method stub
		return commentDao.findList2(queMap);
	}
	
	@Override
	public List<Comment> findList3(Map<String, Object> queMap) {
		// TODO Auto-generated method stub
		return commentDao.findList3(queMap);
	}
	@Override
