...
public class HomeCommentController {
	...
	public ModelAndView index(ModelAndView model,Integer page,HttpServletRequest request){
		...
		model.addObject("commentList2", commentService.findList2(queryMap));
		model.addObject("commentList3", commentService.findList3(queryMap));
		System.out.println(commentService.findList3(queryMap).get(0));
