	...
	<div class="main">
		<div class="login-form fr">
			...
			<div class="form-bd">
				<form>
					<dl>
						<dt>商铺名</dt>
						<dd><input type="text" name="shopname" class="text" /></dd>
					</dl>
					<dl>
						<dt>密码</dt>
					...
					<dl>
						<dt>商铺地址</dt>
						<dd><input type="text" name="address" class="text"/></dd>
					</dl>
					<dl>
						<dt>验证码</dt>
						<dd>
					...
					<dl>
						<dt>&nbsp;</dt>
						<dd><input type="button" id="submit-register" value="申请开店" class="submit"/>
						</dd>
					</dl>
				</form>
		...
		<div class="login-form-left fl">
			<dl class="func clearfix">
				<dt>注册之后您可以</dt>
				<dd class="ico05"><i></i>发布商品</dd>
				<dd class="ico01"><i></i>推广商铺</dd>
			...
			<div class="if">
				<h2>如果您是本站用户</h2>
				<p>我已经注册过账号，立即 <a href="../system/login" class="register">登录</a></p>
			</div>
		</div>
	</div>
...
<script>
	...
	$("#submit-register").click(function(){
		...
		$.ajax({
			url:'register2',
			type:'POST',
			data:{shopname:shopname,password:password,email:email,address:address,code:code},
			dataType:'json',
