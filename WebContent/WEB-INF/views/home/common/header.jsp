...
<%@ page import="com.ischoolbar.programmer.entity.common.Account" %>
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/OnlineShop">XX商城</a></b>
						<c:if test="${account == null }">
						[<a href="../home/login">登录</a>][<a href="../home/register">顾客注册</a>][<a href="../home/register2">申请开店</a>]
						</c:if>
						<c:if test="${account != null }">
						[${account.name }] [<a href="../home/write">发表帖子</a>][<a href="../home/show">查看帖子</a>]
						</c:if>
					</p>
				</div>
				...
				<div class="shop_hd_topNav_all_right">
					<ul class="topNav_quick_menu">
						...
						<li>
							<div class="topNav_menu">
								<a href="../system/login" class="topNavHover">后台登录</a>
							</div>
						</li>
					</ul>
				</div>
